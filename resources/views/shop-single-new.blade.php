            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="page-header-content">
                        <h4 class="title" data-aos="fade-down" data-aos-duration="1200">1. New and sale badge product</h4>
                        <nav class="breadcrumb-area" data-aos="fade-down" data-aos-duration="1000">
                            <ul class="breadcrumb">
                                <li><a href="index.blade.php">Home</a></li>
                                <li class="breadcrumb-sep">-</li>
                                <li>1. New and sale badge product</li>
                            </ul>
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="product-single-slider">
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <div class="zoom zoom-hover">
                                                        <a class="lightbox-image" data-fancybox="gallery" href="assets/img/shop/product-single/5.jpg')}}">
                                                            <img src="{{asset('img/shop/product-single/5.jpg')}}" alt="Image-HasTech">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="zoom zoom-hover">
                                                        <a class="lightbox-image" data-fancybox="gallery" href="assets/img/shop/product-single/6.jpg')}}">
                                                            <img src="{{asset('img/shop/product-single/6.jpg')}}" alt="Image-HasTech">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                    ...
                                    <div class="swiper-container single-product-nav-slider product-nav">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <img src="{{asset('img/shop/product-single/nav5.jpg')}}" alt="Image-HasTech">
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="{{asset('img/shop/product-single/nav2.jpg')}}" alt="Image-HasTech">
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="{{asset('img/shop/product-single/nav6.jpg')}}" alt="Image-HasTech">
                                            </div>
                                            <div class="swiper-slide">
