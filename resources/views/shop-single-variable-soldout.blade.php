        ...
        <div class="col">
          <div class="header-logo-area">
            <a href="index.blade.php">
              <img class="logo-main" src="{{asset('img/logo.jpg')}}" alt="Logo" />
              <img class="logo d-none" src="{{asset('img/logo-light.jpg')}}" alt="Logo" />
            </a>
          </div>
        </div>
        <div class="col">
        ...
        <div class="row">
          <div class="col-12 text-center">
            <div class="page-header-content">
              <h4 class="title" data-aos="fade-down" data-aos-duration="1200">6. Variable with soldout product</h4>
              <nav class="breadcrumb-area" data-aos="fade-down" data-aos-duration="1000">
                <ul class="breadcrumb">
                  <li><a href="index.blade.php">Home</a></li>
                  <li class="breadcrumb-sep">-</li>
                  <li>6. Variable with soldout product</li>
                </ul>
              </nav>
            </div>
          </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  ...
                  <div class="product-single-info">
                    <h4 class="title">6. Variable with soldout product</h4>
                    <div class="prices">
                        ...
                        <div class="product-comment-content">
                          <form action="#">
                            <div class="product-comment">
                              <img src="{{asset('img/photos/comment.jpg')}}" alt="Image-HasTech">
          ...
          <div class="col">
            ...
            <div class="widget-item">
              <div class="footer-logo-area">
                <a href="index.blade.php">
                  <img class="logo-main" src="{{asset('img/logo-light.jpg')}}" alt="Logo" />
                </a>
              </div>
