        ...
        <div class="row">
          <div class="col-12 text-center">
            <div class="page-header-content">
              <h4 class="title" data-aos="fade-down" data-aos-duration="1200">7. Sample affiliate product</h4>
              <nav class="breadcrumb-area" data-aos="fade-down" data-aos-duration="1000">
                <ul class="breadcrumb">
                  <li><a href="index.blade.php">Home</a></li>
                  <li class="breadcrumb-sep">-</li>
                  <li>7. Sample affiliate product</li>
                </ul>
              </nav>
            </div>
          </div>
            ...
            <div class="product-single-item">
              <div class="row">
                ...
                <div class="col-lg-6">
                  ...
                  <div class="product-single-info product-single-affiliate">
                    <h4 class="title">7. Sample affiliate product</h4>
                    <div class="prices">
                    ...
                    <a href="#/" class="affiliate-btn">Buy from amazon</a>
