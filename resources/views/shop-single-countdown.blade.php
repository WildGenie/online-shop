        ...
        <div class="row">
          <div class="col-12 text-center">
            <div class="page-header-content">
              <h4 class="title" data-aos="fade-down" data-aos-duration="1200">8. Countdown product</h4>
              <nav class="breadcrumb-area" data-aos="fade-down" data-aos-duration="1000">
                <ul class="breadcrumb">
                  <li><a href="index.blade.php">Home</a></li>
                  <li class="breadcrumb-sep">-</li>
                  <li>8. Countdown product</li>
                </ul>
              </nav>
            </div>
          </div>
            ...
            <div class="product-single-item">
              <div class="row">
                <div class="col-lg-6">
                  <div class="product-single-slider">
                        ...
                        <div class="swiper-wrapper">
                          <div class="swiper-slide">
                            <div class="zoom zoom-hover">
                              <a class="lightbox-image" data-fancybox="gallery" href="assets/img/shop/product-single/11.jpg')}}">
                                <img src="{{asset('img/shop/product-single/11.jpg')}}" alt="Image-HasTech">
                              </a>
                            </div>
                          </div>
                          <div class="swiper-slide">
                            <div class="zoom zoom-hover">
                              <a class="lightbox-image" data-fancybox="gallery" href="assets/img/shop/product-single/13.jpg')}}">
                                <img src="{{asset('img/shop/product-single/13.jpg')}}" alt="Image-HasTech">
                              </a>
                            </div>
                          </div>
                          <div class="swiper-slide">
                            <div class="zoom zoom-hover">
                              <a class="lightbox-image" data-fancybox="gallery" href="assets/img/shop/product-single/10.jpg')}}">
                                <img src="{{asset('img/shop/product-single/10.jpg')}}" alt="Image-HasTech">
                              </a>
                            </div>
                          </div>
                          <div class="swiper-slide">
                            <div class="zoom zoom-hover">
                              <a class="lightbox-image" data-fancybox="gallery" href="assets/img/shop/product-single/12.jpg')}}">
                                <img src="{{asset('img/shop/product-single/12.jpg')}}" alt="Image-HasTech">
                              </a>
                            </div>
                          </div>
                          <div class="swiper-slide">
                            <div class="zoom zoom-hover">
                              <a class="lightbox-image" data-fancybox="gallery" href="assets/img/shop/product-single/9.jpg')}}">
                                <img src="{{asset('img/shop/product-single/9.jpg')}}" alt="Image-HasTech">
                              </a>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="swiper-container single-product-nav-slider product-nav">
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <img src="{{asset('img/shop/product-single/nav11.jpg')}}" alt="Image-HasTech">
                        </div>
                        <div class="swiper-slide">
                          <img src="{{asset('img/shop/product-single/nav13.jpg')}}" alt="Image-HasTech">
                        </div>
                        <div class="swiper-slide">
                          <img src="{{asset('img/shop/product-single/nav10.jpg')}}" alt="Image-HasTech">
                        </div>
                        <div class="swiper-slide">
                          <img src="{{asset('img/shop/product-single/nav12.jpg')}}" alt="Image-HasTech">
                        </div>
                        <div class="swiper-slide">
                          <img src="{{asset('img/shop/product-single/nav9.jpg')}}" alt="Image-HasTech">
                        </div>
                      </div>
                ...
                <div class="col-lg-6">
                  ...
                  <div class="product-single-info product-single-countdown">
                    <h4 class="title">8. Countdown product</h4>
                    <div class="prices">
                      ...
                      <div class="select-item">
                        <div class="select-color-wrap">
                          ...
                          <ul>
                            ...
                            <li class="green disabled"></li>
                            <li class="blue"></li>
                            <li class="yellow"></li>
                            <li class="white"></li>
                            <li class="gold disabled"></li>
                            <li class="gray disabled"></li>
                          </ul>
                        </div>
                      </div>
                    </div>
