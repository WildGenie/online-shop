        ...
        <div class="row">
          <div class="col-12 text-center">
            <div class="page-header-content">
              <h4 class="title" data-aos="fade-down" data-aos-duration="1200">About</h4>
              ...
              <div class="row">
                ...
                <div class="col-lg-6 col-xl-5 offset-xl-1">
                  <div class="about-thumb">
                    <img class="w-100" src="{{asset('img/about/3.jpg')}}" alt="Image-HasTech">
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div class="testi-inner-content">
                      <div class="testi-author content">
                        <div class="testi-content">
                          <p>We provide the best Beard oil all over the world. We are the world best store for Beard Oil. You can buy our product without any hesitation because we always conscious about our product quality and always maintain it properly, so you can trust and this is our main goal we believe that...</p>
                        </div>
                        <div class="testi-info">
                          <span class="name">James William</span>
                  ...
                  <div class="testimonial-item">
                    <div class="testi-inner-content">
                      <div class="testi-author content">
                        ...
                        <div class="testi-info">
                          <span class="name">Emma Olivia</span>
                          <span class="designation">Designation</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="testimonial-item">
                    <div class="testi-inner-content">
                      <div class="testi-author content">
                        ...
                        <div class="testi-info">
                          <span class="name">Jacob Liam</span>
                          <span class="designation">Designation</span>
                        </div>
                      </div>
                    </div>
                ...
                <div class="swiper-slide">
                  ...
                  <div class="testimonial-item">
                    <div class="testi-inner-content">
                      <div class="testi-author">
                        <div class="testi-thumb">
                          <img src="{{asset('img/testimonial/2.jpg')}}" alt="Image-HasTech">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  ...
                  <div class="testimonial-item">
                    <div class="testi-inner-content">
                      <div class="testi-author">
                        <div class="testi-thumb">
                          <img src="{{asset('img/testimonial/3.jpg')}}" alt="Image-HasTech">
                        </div>
                      </div>
                    </div>
                  </div>
...
var testimonialThumbs = new Swiper('.testimonial-thumbs', {
  ...
  loop: true,
  navigation: {
    nextEl: '.testimonial-thumbs .swiper-button-next',
    prevEl: '.testimonial-thumbs .swiper-button-prev',
  },
  loopedSlides: 4,
});
