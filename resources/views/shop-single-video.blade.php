...
<head>
    ...
    <title>Single Video Product – Diana – Furniture Store eCommerce Bootstrap5 Template</title>
        ...
        <div class="row">
          <div class="col-12 text-center">
            <div class="page-header-content">
              <h4 class="title" data-aos="fade-down" data-aos-duration="1200">11. Product with video</h4>
              <nav class="breadcrumb-area" data-aos="fade-down" data-aos-duration="1000">
                <ul class="breadcrumb">
                  <li><a href="index.blade.php">Home</a></li>
                  <li class="breadcrumb-sep">-</li>
                  <li>11. Product with video</li>
                </ul>
              </nav>
            </div>
          </div>
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="product-single-slider">
                        ...
                        <div class="swiper-wrapper">
                          <div class="swiper-slide">
                            <div class="zoom zoom-hover">
                              <a class="lightbox-image" data-fancybox="gallery" href="assets/img/shop/product-single/7.jpg')}}">
                                <img src="{{asset('img/shop/product-single/7.jpg')}}" alt="Image-HasTech">
                              </a>
                            </div>
                          </div>
                          <div class="swiper-slide">
                    ...
                    <div class="swiper-container single-product-nav-slider product-nav">
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <img src="{{asset('img/shop/product-single/nav7.jpg')}}" alt="Image-HasTech">
                        </div>
                        <div class="swiper-slide">
                ...
                <div class="col-lg-6">
                  ...
                  <div class="product-single-info">
                    <h4 class="title">11. Product with video</h4>
                    <div class="prices">
                ...
                <div class="col-12">
                  <div class="product-review-tabs-content">
                    <div class="nav nav-tabs product-tab-nav" id="ReviewTab" role="tablist">
                      ...
                      <button class="nav-link" id="product-video-tab" data-bs-toggle="tab" data-bs-target="#product-video" type="button" aria-controls="product-video" aria-selected="false">Video</button>
                    ...
                    <div class="tab-content product-tab-content" id="ReviewTabContent">
                      ...
                      <div class="tab-pane fade" id="product-video" role="tabpanel" aria-labelledby="product-tab">
                        <div class="product-video-content">
                          <iframe src="https://www.youtube.com/embed/2df62ekI9UY" frameborder="0" allowfullscreen></iframe>
                        </div>
                      </div>
